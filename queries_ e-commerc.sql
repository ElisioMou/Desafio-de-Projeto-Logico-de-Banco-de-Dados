...
insert into clients(Fname, Minit, Lname, CPF, Address) 
					values   ('Ana','M','Braga', 369369369, 'rua josé fonseca e silva 39, Ubatão - SP'),
					         ('Maria','J','Silva', 12346789, 'rua silva de prata 29, Carangola - SP'),
							 ('Matheus','O','Pimentel', 987654321,'rua alemeda 289, Centro - SP'),
							 ('Ricardo','F','Silva', 45678913,'avenida alemeda vinha 1009, Centro - RJ'),
							 ('Karina','S','Braz', 789123456,'rua lareijras 861, Centro - SP'),
							 ('Roberta','G','Assis', 98745631,'avenidade koller 19, Centro - SP'),
							 ('Julia','M','Cruz', 654789123,'rua alemeda dos Lirios 28, Sao José dos Campos - SP');
                             
desc product;
insert into product(Pname, Classification_kids, Category, Feedback, Size) 
						values ('Pad mouse',false,'Acessórios','1',null),
							  ...
							  ('Kit churrasco', False,'Utilitários','2',null);
